...
var parserApiToken = ''; 	//get your own from http://www.readability.com/developers/api/parser
var solrHost = 'http://localhost:8983/solr'; //where solr lives (without trailing slash)
...
// 	magnify - makes section lerge and shows articles in full sizeToContent
...
function articleSection(options){
	...
	this.name = options.name; // name to differentiate betweenn different articleSections. This is currently only used to give tag dropdowns unique ids
